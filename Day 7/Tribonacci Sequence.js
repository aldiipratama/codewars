 ...
 *
 * If you enjoyed this kata more advanced and generalized version of it can be found
 *  in the Xbonacci kata
 *
...
const tribonacci = (signature, n) => {
  arr = [...signature];
  for (let i = 0; i < n; i++) {
    arr.push(arr.slice(i, i + 3).reduce((acc, curr) => acc + curr));
  }
